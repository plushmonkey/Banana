...
public class HistoryCommand extends Command {
    ...
    public HistoryCommand(BananaPlugin plugin) {
        super("history");
        this.plugin = plugin;
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (playerPunishments.isEmpty() && ipPunishments.isEmpty()) {
            sender.sendMessage(new ComponentBuilder("No punishments for ").color(ChatColor.GOLD).append(target.getName()).color(ChatColor.DARK_AQUA).create());
        }
    }
}
